...
#       once every 30,000 miles || once every 2 years
...
#           once every 60,000 miles || once every 2 years
...
# Palindrome:	     Sternman Engine    || Nubbin Battery
# only when the warning indicator is on || once every 4 years
...
#                 once every 60,000 miles || once every 4 years
...
#       once every 30,000 miles  || once every 4 years
